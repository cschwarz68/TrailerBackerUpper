...
def modify_video():
    ...
    video_file = video_directory + "/video_test.h264"
    ...
    try:
        ...
        while cap.isOpened():
            ...
            # cv2.imwrite("%s_03d_%03d.png" % (video_file, i, steering_angle), frame)
            cv2.imwrite(
                f"test_captures/video_testing/video01_{i}_{steering_angle}.png", frame
            )
            i += 1
